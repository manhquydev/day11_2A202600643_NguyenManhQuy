// Gemini 2.5 Flash client for AI-assisted attack generation and analysis
...
async function generateTailoredAttacks(apiKey, defenderResponse, previousAttacks = []) {
...
async function analyzeFailedAttack(apiKey, attackPrompt, agentResponse) {
...
async function generateSingleAttack(apiKey, technique, context = "") {
